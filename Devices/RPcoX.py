...
ALLOWED_ADD_ATTRS = ('name', 'processor', 'connection', 'index', 'rcx_path')


def allow_defined_setattr(self, name, value):
    ...
    if name[:1] != '_' and name in ALLOWED_ADD_ATTRS:
...
DispatchBaseClass.__setattr__ = allow_defined_setattr
...
class _DRPcoX(DispatchBaseClass):
    ...
    def GetNames(self, NameList=defaultNamedNotOptArg, MaxNames=defaultNamedNotOptArg, ObjType=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(13, LCID, 1, (3, 0), ((8, 0), (3, 0), (3, 0)),
                                         NameList, MaxNames, ObjType)
    ...
    def ReadTag(self, Name=defaultNamedNotOptArg, pBuf=defaultNamedNotOptArg,
        ...
        return self._oleobj_.InvokeTypes(9, LCID, 1, (3, 0), ((8, 0), (16388, 0), (3, 0), (3, 0)),
                                         Name, pBuf, nOS, nWords)

    def ReadTagV(self, Name=defaultNamedNotOptArg, nOS=defaultNamedNotOptArg, nWords=defaultNamedNotOptArg):
        return self._ApplyTypes_(14, 1, (12, 0), ((8, 0), (3, 0), (3, 0)), u'ReadTagV', None,
                                 Name, nOS, nWords)

    def ReadTagVEX(self, Name=defaultNamedNotOptArg, nOS=defaultNamedNotOptArg,
                   nWords=defaultNamedNotOptArg, SrcType=defaultNamedNotOptArg,
                   DstType=defaultNamedNotOptArg, nChans=defaultNamedNotOptArg):
        return self._ApplyTypes_(25, 1, (12, 0), ((8, 0), (3, 0), (3, 0), (8, 0), (8, 0), (3, 0)), u'ReadTagVEX', None,
    ...
    def SendParTable(self, Name=defaultNamedNotOptArg, IndexID=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(11, LCID, 1, (3, 0), ((8, 0), (4, 0)),
                                         Name, IndexID)

    def SendSrcFile(self, Name=defaultNamedNotOptArg, SeekOS=defaultNamedNotOptArg, nWords=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(12, LCID, 1, (3, 0), ((8, 0), (3, 0), (3, 0)),
                                         Name, SeekOS, nWords)

    def SetDevCfg(self, Addr=defaultNamedNotOptArg, Val=defaultNamedNotOptArg, Width32=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(34, LCID, 1, (3, 0), ((3, 0), (3, 0), (3, 0)),
                                         Addr, Val, Width32)

    def SetSrcFileName(self, Name=defaultNamedNotOptArg, FileName=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(18, LCID, 1, (3, 0), ((8, 0), (8, 0)),
                                         Name, FileName)

    def SetTagVal(self, Name=defaultNamedNotOptArg, Val=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(3, LCID, 1, (3, 0), ((8, 0), (4, 0)),
                                         Name, Val)

    def SoftTrg(self, Trg_Bitn=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(7, LCID, 1, (3, 0), ((3, 0),), Trg_Bitn)

    def WriteTag(self, Name=defaultNamedNotOptArg, pBuf=defaultNamedNotOptArg,
                 nOS=defaultNamedNotOptArg, nWords=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(10, LCID, 1, (3, 0), ((8, 0), (16388, 0), (3, 0), (3, 0)),
                                         Name, pBuf, nOS, nWords)

    def WriteTagV(self, Name=defaultNamedNotOptArg, nOS=defaultNamedNotOptArg, Buf=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(15, LCID, 1, (3, 0), ((8, 0), (3, 0), (0x2005, 0)),
                                         Name, nOS, Buf)

    def WriteTagVEX(self, Name=defaultNamedNotOptArg, nOS=defaultNamedNotOptArg,
                    DstType=defaultNamedNotOptArg, Buf=defaultNamedNotOptArg):
        return self._oleobj_.InvokeTypes(29, LCID, 1, (3, 0), ((8, 0), (3, 0), (8, 0), (0x2005, 0)),
                                         Name, nOS, DstType, Buf)
